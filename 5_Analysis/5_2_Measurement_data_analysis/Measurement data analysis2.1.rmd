...
pdf("figure/EGA_network_plot_unmerge.pdf", width = 10, height = 8)
...
write_xlsx(new_2_network_data, "data/data3.xlsx")
```
...
pdf("figure/EGA_network_plot_merge.pdf", width = 10, height = 8)
